...
def serialize_context(ctx: Context) -> Dict[str, Any]:
    return {
        ...
        "minute": ctx.minute,
        "possession_pct": ctx.possession_pct,
        "shots_for": ctx.shots_for,
        "shots_against": ctx.shots_against,
        "shots_on_target_for": ctx.shots_on_target_for,
        "shots_on_target_against": ctx.shots_on_target_against,
        "xg_for": ctx.xg_for,
        "xg_against": ctx.xg_against,
...
def deserialize_context(d: Dict[str, Any]) -> Context:
    ...
    return Context(
        ...
        shots_on_target_for=d.get("shots_on_target_for"),
        shots_on_target_against=d.get("shots_on_target_against"),
        xg_for=d.get("xg_for"),
